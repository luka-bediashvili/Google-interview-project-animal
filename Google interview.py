...
##                button7 = ttk.Button(self.frame, text='Suggestion '+self.Address[0][0],width=50, command=lambda: self.update_text(self.Address[0][0]))
##                button7.grid(row=2, column=7, sticky=W)
##            else:
##                Label_7 = Label(self.frame, text=' ',width=50)
...
##            window.destroy() 
    ...
    def show_data(self):
        ...
        button3.grid(row=3, column=3, sticky=W)       
        if len(self.data)>0:
            y=5
            for i in range(self.count-5,self.count):
                if i==len(self.data):
                    ...
                    result0 = Label(self.frame, text=self.data[i][0],width=25,background='White')
                    result0.grid(row=y, column=1, sticky=W)
                    result1 = Label(self.frame, text=self.data[i][1],width=25,background='White')
                    result1.grid(row=y, column=2, sticky=W)
                    result2 = Label(self.frame, text=self.data[i][2],width=25,background='White')
                    result2.grid(row=y, column=3, sticky=W)
                    result3 = Label(self.frame, text=self.data[i][3],width=25,background='White')
                    ...
                    result6 = Label(self.frame, text=self.data[i][6],width=50,background='White')
